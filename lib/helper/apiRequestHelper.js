...
async function makePaymentRequest(options) {
  const {method,baseUrl, endpoint, requestData, headers } = options;
...
async function makeTransactionServiceRequest(options) {
  const {method, baseUrl, endpoint, gid, requestData, headers, operation } = options;
...
async function makeSiServiceRequest(options) {
  const {method,baseUrl, endpoint, requestData, headers, operation } = options;
