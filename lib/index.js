...
const { initiateSiOnDemandVariable, initiateSiOnDemandFixed } = require('./services/siOnDemand');
const { initiateSiStatusCheck } = require('./services/siStatus');
...
class PayGlocalClient {
  ...
  async initiateSiOnDemandVariable(params) {
    return initiateSiOnDemandVariable(params, this.config);
  }

  async initiateSiOnDemandFixed(params) {
    return initiateSiOnDemandFixed(params, this.config);
  }

  async initiateSiStatusCheck(params) {
    return initiateSiStatusCheck(params, this.config);
  }
